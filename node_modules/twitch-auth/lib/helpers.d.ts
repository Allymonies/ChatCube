...
import ***REMOVED*** AccessToken ***REMOVED*** from './AccessToken';
import type ***REMOVED*** AuthProvider ***REMOVED*** from './AuthProvider/AuthProvider';
import ***REMOVED*** TokenInfo ***REMOVED*** from './TokenInfo';
/**
...
/** @private */
export declare function getValidTokenFromProvider(provider: AuthProvider, scopes?: string[], logger?: Logger): Promise<***REMOVED***
