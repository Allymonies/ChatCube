import type ***REMOVED*** AccessToken ***REMOVED*** from '../AccessToken';
import type ***REMOVED*** AuthProvider, AuthProviderTokenType ***REMOVED*** from './AuthProvider';
/**
 * Configuration for the ***REMOVED***@RefreshableAuthProvider***REMOVED***.
 */
export interface RefreshConfig ***REMOVED***
    /**
 ...
 */
export declare class RefreshableAuthProvider implements AuthProvider ***REMOVED***
