 ...
 *
 * As a starting point, ***REMOVED***@StaticAuthProvider***REMOVED*** takes an access token,
 * but can't do anything to upgrade it by itself. ***REMOVED***@RefreshableAuthProvider***REMOVED***
