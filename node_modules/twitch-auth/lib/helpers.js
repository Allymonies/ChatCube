 ...
 */
function exchangeCode(clientId, clientSecret, code, redirectUri) ***REMOVED***
        ...
        return tslib_1.__generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
                case 0:
                    ...
                    return [4 /*yield*/, twitch_api_call_1.callTwitchApi(***REMOVED***
 ...
 * @param clientSecret
 */
function getAppToken(clientId, clientSecret) ***REMOVED***
    return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var _a;
        return tslib_1.__generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
 ...
 */
function refreshUserToken(clientId, clientSecret, refreshToken) ***REMOVED***
    return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var _a;
        return tslib_1.__generator(this, function (_b) ***REMOVED***
            switch (_b.label) ***REMOVED***
 ...
 */
function revokeToken(clientId, accessToken) ***REMOVED***
    return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
        return tslib_1.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0: return [4 /*yield*/, twitch_api_call_1.callTwitchApi(***REMOVED***
                        type: twitch_api_call_1.TwitchApiCallType.Auth,
                        url: 'revoke',
                        method: 'POST',
                        query: ***REMOVED***
 ...
 */
function getTokenInfo(accessToken, clientId) ***REMOVED***
    return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
        var data, e_1;
        return tslib_1.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, twitch_api_call_1.callTwitchApi(***REMOVED*** type: twitch_api_call_1.TwitchApiCallType.Auth, url: 'validate' ***REMOVED***, clientId, accessToken)];
                case 1:
                    data = _a.sent();
...
/** @private */
function getValidTokenFromProvider(provider, scopes, logger) ***REMOVED***
    return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
        ...
        return tslib_1.__generator(this, function (_a) ***REMOVED***
            switch (_a.label) ***REMOVED***
                ...
                case 3:
                    tokenInfo = _a.sent();
                    return [2 /*return*/, ***REMOVED*** accessToken: accessToken, tokenInfo: tokenInfo ***REMOVED***];
                case 4: return [3 /*break*/, 6];
                case 5:
                    e_2 = _a.sent();
                    if (e_2 instanceof InvalidTokenError_1.InvalidTokenError) ***REMOVED***
                        lastTokenError = e_2;
                    ***REMOVED***
                    else ***REMOVED***
                ...
                case 9:
                    tokenInfo = _a.sent();
                    return [2 /*return*/, ***REMOVED*** accessToken: newToken, tokenInfo: tokenInfo ***REMOVED***];
                case 10: return [3 /*break*/, 12];
                case 11:
                    e_3 = _a.sent();
                    if (e_3 instanceof InvalidTokenError_1.InvalidTokenError) ***REMOVED***
                        lastTokenError = e_3;
                    ***REMOVED***
                    else ***REMOVED***
