...
assert(toPrimitive(function () ***REMOVED******REMOVED***) === String(function () ***REMOVED******REMOVED***));

var date = new Date();
assert(toPrimitive(date) === String(date));

assert(toPrimitive(***REMOVED*** valueOf: function () ***REMOVED*** return 3; ***REMOVED*** ***REMOVED***) === 3);
