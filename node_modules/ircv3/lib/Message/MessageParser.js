...
function parsePrefix(raw) ***REMOVED***
...
var tagUnescapeMap = ***REMOVED***
    ...
    s: ' '
***REMOVED***;
function parseTags(raw) ***REMOVED***
    var e_1, _a;
    var tags = new Map();
    var tagStrings = raw.split(';');
    try ***REMOVED***
        for (var tagStrings_1 = tslib_1.__values(tagStrings), tagStrings_1_1 = tagStrings_1.next(); !tagStrings_1_1.done; tagStrings_1_1 = tagStrings_1.next()) ***REMOVED***
...
function parseMessage(line, serverProperties, knownCommands, isServer, nonConformingCommands) ***REMOVED***
    if (serverProperties === void 0) ***REMOVED*** serverProperties = ServerProperties_1.defaultServerProperties; ***REMOVED***
    if (knownCommands === void 0) ***REMOVED*** knownCommands = MessageTypes_1.all; ***REMOVED***
