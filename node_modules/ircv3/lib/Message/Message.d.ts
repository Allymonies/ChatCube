import type ***REMOVED*** AllowedNames ***REMOVED*** from '@d-fischer/shared-utils';
import type ***REMOVED*** ServerProperties ***REMOVED*** from '../ServerProperties';
export interface MessagePrefix ***REMOVED***
    nick: string;
    user?: string;
    host?: string;
***REMOVED***
export interface MessageParam ***REMOVED***
    value: string;
    trailing: boolean;
***REMOVED***
export interface MessageParamSpecEntry ***REMOVED***
    trailing?: boolean;
    rest?: boolean;
    optional?: boolean;
    noClient?: boolean;
    ...
    match?: RegExp;
***REMOVED***
export interface MessageConstructor<T extends Message<T> = any> extends Function ***REMOVED***
    COMMAND: string;
...
export declare class Message<T extends Message<T> = any> ***REMOVED***
    ...
    tagsToString(): string;
    toString(includePrefix?: boolean): string;
    /** @private */
