...
var IrcClient = /** @class */ (function (_super) ***REMOVED***
    tslib_1.__extends(IrcClient, _super);
    function IrcClient(options) ***REMOVED***
        ...
        _this._serverProperties = json_1.klona(ServerProperties_1.defaultServerProperties);
        ...
        _this._logger = logger_1.createLogger(tslib_1.__assign(***REMOVED*** name: 'ircv3', emoji: true ***REMOVED***, logger));
        ...
        var connectionOptions = ***REMOVED***
            ...
            lineBased: true
        ***REMOVED***;
        var ConnectionType = webSocket ? connection_1.WebSocketConnection : connection_1.DirectConnection;
        if (reconnect) ***REMOVED***
            _this._connection = new connection_1.PersistentConnection(ConnectionType, connectionOptions, ***REMOVED*** logger: _this._logger ***REMOVED***, options.connectionOptions);
        ***REMOVED***
        else ***REMOVED***
            _this._connection = new ConnectionType(connectionOptions, _this._logger, options.connectionOptions);
        ***REMOVED***
        try ***REMOVED***
            for (var _f = tslib_1.__values(Object.values(CoreCapabilities)), _g = _f.next(); !_g.done; _g = _f.next()) ***REMOVED***
                var cap = _g.value;
        ...
        ***REMOVED***
        if (channels) ***REMOVED***
            _this.onRegister(function () ***REMOVED*** return tslib_1.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                    ...
                    switch (_b.label) ***REMOVED***
                        ...
                        case 1:
                            ...
                            if (resolvedChannels) ***REMOVED***
                                try ***REMOVED***
                                    for (resolvedChannels_1 = tslib_1.__values(resolvedChannels), resolvedChannels_1_1 = resolvedChannels_1.next(); !resolvedChannels_1_1.done; resolvedChannels_1_1 = resolvedChannels_1.next()) ***REMOVED***
            ...
            ***REMOVED***); ***REMOVED***);
        ***REMOVED***
        _this.onTypedMessage(Commands_1.CapabilityNegotiation, function (_a) ***REMOVED***
            var _b = _a.params, subCommand = _b.subCommand, capabilities = _b.capabilities;
            return tslib_1.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                var caps, _c, capList, _d, _e, _f, name, cap, capNames_1, caps_1, caps_1_1, cap;
                var e_3, _g, e_4, _h;
                return tslib_1.__generator(this, function (_j) ***REMOVED***
                    switch (_j.label) ***REMOVED***
                        ...
                        case 1:
                            ...
                            capList = shared_utils_1.arrayToObject(caps, function (part) ***REMOVED***
                                var _a;
                                if (!part) ***REMOVED***
                                    return ***REMOVED******REMOVED***;
                                ***REMOVED***
                                var _b = tslib_1.__read(shared_utils_1.splitWithLimit(part, '=', 2), 2), cap = _b[0], param = _b[1];
                            ...
                            ***REMOVED***);
                            try ***REMOVED***
                                for (_d = tslib_1.__values(Object.entries(capList)), _e = _d.next(); !_e.done; _e = _d.next()) ***REMOVED***
                                    _f = tslib_1.__read(_e.value, 2), name = _f[0], cap = _f[1];
                            ...
                            ***REMOVED***
                            ...
                            return [4 /*yield*/, this._negotiateCapabilities(Array.from(this._clientCapabilities.entries())
                                ...
                                ***REMOVED***)
                                    ...
                                    var _b = tslib_1.__read(_a, 2), cap = _b[1];
                                    return cap;
                                ***REMOVED***))];
                        case 2:
                            _j.sent();
                        ...
                        case 3:
                            ***REMOVED***
                                ...
                                try ***REMOVED***
                                    for (caps_1 = tslib_1.__values(caps), caps_1_1 = caps_1.next(); !caps_1_1.done; caps_1_1 = caps_1.next()) ***REMOVED***
                                        cap = caps_1_1.value;
            ...
            ***REMOVED***);
        ***REMOVED***);
        _this.onTypedMessage(Commands_1.Ping, function (_a) ***REMOVED***
            var message = _a.params.message;
            _this.sendMessage(Commands_1.Pong, ***REMOVED*** message: message ***REMOVED***);
        ***REMOVED***);
        _this.onTypedMessage(Numerics_1.Reply001Welcome, function (_a) ***REMOVED***
            var me = _a.params.me;
            _this._handleReceivedClientNick(me);
        ***REMOVED***);
        _this.onTypedMessage(Numerics_1.Reply004ServerInfo, function (_a) ***REMOVED***
            var userModes = _a.params.userModes;
            if (userModes) ***REMOVED***
                _this._serverProperties.supportedUserModes = userModes;
            ***REMOVED***
        ***REMOVED***);
        _this.onTypedMessage(Numerics_1.Reply005Isupport, function (_a) ***REMOVED***
            var supports = _a.params.supports;
            var newFeatures = shared_utils_1.arrayToObject(supports.split(' '), function (part) ***REMOVED***
                var _a;
                var _b = tslib_1.__read(shared_utils_1.splitWithLimit(part, '=', 2), 2), support = _b[0], param = _b[1];
                return _a = ***REMOVED******REMOVED***, _a[support] = param || true, _a;
            ***REMOVED***);
            _this._supportedFeatures = tslib_1.__assign(tslib_1.__assign(***REMOVED******REMOVED***, _this._supportedFeatures), newFeatures);
        ***REMOVED***);
        _this.onTypedMessage(Numerics_1.Reply376EndOfMotd, function (_a) ***REMOVED***
            var me = _a.params.me;
            ...
            ***REMOVED***
        ***REMOVED***);
        _this.onTypedMessage(Numerics_1.Error422NoMotd, function (_a) ***REMOVED***
            var me = _a.params.me;
            if (!_this._registered) ***REMOVED***
                _this._handleReceivedClientNick(me);
                _this._registered = true;
            ...
            ***REMOVED***
        ***REMOVED***);
        _this.onTypedMessage(Numerics_1.Error462AlreadyRegistered, function (_a) ***REMOVED***
            var me = _a.params.me;
            ...
            ***REMOVED***
        ***REMOVED***);
        _this.onTypedMessage(Commands_1.PrivateMessage, function (msg) ***REMOVED***
            var _a;
            ...
            ***REMOVED***
        ***REMOVED***);
        _this.onTypedMessage(Commands_1.NickChange, function (msg) ***REMOVED***
            var _a;
        ...
        ***REMOVED***);
        _this.onTypedMessage(Commands_1.Notice, function (msg) ***REMOVED***
            var _a;
            var _b = msg.params, target = _b.target, message = _b.message;
            var ctcpMessage = StringTools_1.decodeCtcp(message);
            var nick = (_a = msg.prefix) === null || _a === void 0 ? void 0 : _a.nick;
        ...
        ***REMOVED***);
        ...
        _this._credentials = tslib_1.__assign(***REMOVED******REMOVED***, credentials);
    ...
    ***REMOVED***;
    Object.defineProperty(IrcClient.prototype, "serverProperties", ***REMOVED***
        get: function () ***REMOVED***
            return json_1.klona(this._serverProperties);
    ***REMOVED***
        enumerable: false,
        configurable: true
    ***REMOVED***);
    ...
    ***REMOVED***);
    IrcClient.prototype.pingCheck = function () ***REMOVED***
        ...
        var handler = this.onTypedMessage(Commands_1.Pong, function (msg) ***REMOVED***
            ...
            ***REMOVED***
        ***REMOVED***);
        this._pingTimeoutTimer = setTimeout(function () ***REMOVED*** return tslib_1.__awaiter(_this, void 0, void 0, function () ***REMOVED***
        ...
        ***REMOVED***); ***REMOVED***, this._pingTimeout * 1000);
        this.sendMessage(Commands_1.Ping, ***REMOVED*** message: nowStr ***REMOVED***);
    ***REMOVED***;
                ...
                ***REMOVED***
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        ...
                        var registerListener = _this.onRegister(function () ***REMOVED***
                            ...
                            resolve();
                        ***REMOVED***);
                        errorListener = _this.onTypedMessage(Commands_1.ErrorMessage, function (msg) ***REMOVED***
                            registerListener.unbind();
                            _this.removeMessageListener(errorListener);
                            disconnectListener.unbind();
                            reject(new MessageError_1.MessageError(msg));
                        ***REMOVED***);
    ...
    ***REMOVED***;
    IrcClient.prototype.addCapability = function (cap) ***REMOVED***
        ...
        if (cap.messageTypes) ***REMOVED***
            try ***REMOVED***
                for (var _b = tslib_1.__values(cap.messageTypes), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
    ...
    ***REMOVED***;
    IrcClient.prototype.removeMessageListener = function (handlerName) ***REMOVED***
        var _a = tslib_1.__read(handlerName.split(':'), 1), commandName = _a[0];
        if (!this._events.has(commandName)) ***REMOVED***
            return;
        ***REMOVED***
    ...
    ***REMOVED***;
    IrcClient.prototype.createMessage = function (type, params, tags) ***REMOVED***
        ...
        return Message_1.createMessage(type, params, undefined, tagsMap, this.serverProperties);
    ***REMOVED***;
    ...
    ***REMOVED***);
    ...
    IrcClient.prototype.collect = function (originalMessage) ***REMOVED***
        ...
        ***REMOVED***
        var collector = new (MessageCollector_1.MessageCollector.bind.apply(MessageCollector_1.MessageCollector, tslib_1.__spread([void 0, this, originalMessage], types)))();
    ...
    ***REMOVED***;
    ...
    IrcClient.prototype.join = function (channel, key) ***REMOVED***
        this.sendMessage(Commands_1.ChannelJoin, ***REMOVED*** channel: channel, key: key ***REMOVED***);
    ***REMOVED***;
    IrcClient.prototype.part = function (channel) ***REMOVED***
        this.sendMessage(Commands_1.ChannelPart, ***REMOVED*** channel: channel ***REMOVED***);
    ***REMOVED***;
    IrcClient.prototype.quit = function (message) ***REMOVED***
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            var _this = this;
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                this.sendMessage(Commands_1.ClientQuit, ***REMOVED*** message: message ***REMOVED***);
    ...
    ***REMOVED***;
    IrcClient.prototype.say = function (target, message, tags) ***REMOVED***
        ...
        this.sendMessage(Commands_1.PrivateMessage, ***REMOVED*** target: target, message: message ***REMOVED***, tags);
    ***REMOVED***;
    ...
    ***REMOVED***;
    IrcClient.prototype.registerCoreMessageTypes = function () ***REMOVED***
        var _this = this;
        shared_utils_1.forEachObjectEntry(MessageTypes.Commands, function (type) ***REMOVED***
            _this.registerMessageType(type);
        ***REMOVED***);
        shared_utils_1.forEachObjectEntry(MessageTypes.Numerics, function (type) ***REMOVED***
            _this.registerMessageType(type);
        ***REMOVED***);
    ***REMOVED***;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, Promise.all(capabilities
                        ...
                        .map(function (capList) ***REMOVED*** return tslib_1.__awaiter(_this, void 0, void 0, function () ***REMOVED*** return tslib_1.__generator(this, function (_a) ***REMOVED***
    ...
    IrcClient.prototype._negotiateCapabilities = function (capList) ***REMOVED***
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
                        mappedCapList = shared_utils_1.arrayToObject(capList, function (cap) ***REMOVED***
                            var _a;
                            return (_a = ***REMOVED******REMOVED***,
                                _a[cap.name] = cap,
                                _a);
                        ***REMOVED***);
                        return [4 /*yield*/, this.sendMessageAndCaptureReply(Commands_1.CapabilityNegotiation, ***REMOVED***
                                subCommand: 'REQ',
                    ...
                    case 1:
                        ...
                        ***REMOVED***
                        if (!(capReply instanceof Commands_1.CapabilityNegotiation)) ***REMOVED***
                        ...
                        ***REMOVED***
                        ...
                        if (capReply.params.subCommand === 'ACK') ***REMOVED***
                            ...
                            try ***REMOVED***
                                for (newNegotiatedCaps_1 = tslib_1.__values(newNegotiatedCaps), newNegotiatedCaps_1_1 = newNegotiatedCaps_1.next(); !newNegotiatedCaps_1_1.done; newNegotiatedCaps_1_1 = newNegotiatedCaps_1.next()) ***REMOVED***
    ...
    ***REMOVED***;
    IrcClient.prototype._updateCredentials = function (newCredentials) ***REMOVED***
        this._credentials = tslib_1.__assign(tslib_1.__assign(***REMOVED******REMOVED***, this._credentials), newCredentials);
    ***REMOVED***;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                if (this._initialConnectionSetupDone) ***REMOVED***
                    return [2 /*return*/];
                ***REMOVED***
                this._connection.onConnect(function () ***REMOVED*** return tslib_1.__awaiter(_this, void 0, void 0, function () ***REMOVED***
                    var _a, password;
                    var _this = this;
                    var _b, _c;
                        ...
                        switch (_d.label) ***REMOVED***
                            case 0:
                                ...
                                return [4 /*yield*/, Promise.all([
                                        ...
                                        this.sendMessageAndCaptureReply(Commands_1.CapabilityNegotiation, ***REMOVED***
                                            subCommand: 'LS',
                                            version: '302'
                                        ***REMOVED***)
                                            .then(function (capReply) ***REMOVED***
                                            if (!capReply.length || !(capReply[0] instanceof Commands_1.CapabilityNegotiation)) ***REMOVED***
                                                _this._logger.debug('Server does not support capabilities');
                                                return [];
                                            ***REMOVED***
                                            _this._supportsCapabilities = true;
                                            var capLists = capReply.map(function (line) ***REMOVED***
                                                return shared_utils_1.arrayToObject(line.params.capabilities.split(' '), function (part) ***REMOVED***
                                                    var _a;
                                                    if (!part) ***REMOVED***
                                                        return ***REMOVED******REMOVED***;
                                                    ***REMOVED***
                                                ...
                                                ***REMOVED***);
                                            ***REMOVED***);
                                            _this._serverCapabilities = new Map(Object.entries(Object.assign.apply(Object, tslib_1.__spread([***REMOVED******REMOVED***], capLists))));
                                        ...
                                        ***REMOVED***)
                                            ...
                                            _this.sendMessage(Commands_1.CapabilityNegotiation, ***REMOVED*** subCommand: 'END' ***REMOVED***);
                                        ***REMOVED***)
                                    ])];
                            case 1:
                                _a = tslib_1.__read.apply(void 0, [_d.sent(), 1]), password = _a[0];
                                if (password && password !== this._credentials.password) ***REMOVED***
                                    this._updateCredentials(***REMOVED*** password: password ***REMOVED***);
                                ***REMOVED***
                                if (password) ***REMOVED***
                                    this.sendMessage(Commands_1.Password, ***REMOVED*** password: password ***REMOVED***);
                                ***REMOVED***
                                this.sendMessage(Commands_1.NickChange, ***REMOVED*** nick: this._credentials.nick ***REMOVED***);
                                this.sendMessage(Commands_1.UserRegistration, ***REMOVED***
    ...
    ***REMOVED***;
    ...
    IrcClient.prototype._handleEvents = function (message) ***REMOVED***
        ...
        ***REMOVED***
        try ***REMOVED***
            for (var _b = tslib_1.__values(handlers.values()), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
