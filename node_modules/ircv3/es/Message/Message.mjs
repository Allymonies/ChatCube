import ***REMOVED*** __assign, __read, __spread, __values ***REMOVED*** from "tslib";
import ***REMOVED*** forEachObjectEntry ***REMOVED*** from '@d-fischer/shared-utils';
import ***REMOVED*** NotEnoughParametersError ***REMOVED*** from "../Errors/NotEnoughParametersError.mjs";
import ***REMOVED*** ParameterRequirementMismatchError ***REMOVED*** from "../Errors/ParameterRequirementMismatchError.mjs";
...
***REMOVED***
export function prefixToString(prefix) ***REMOVED***
    ...
    ***REMOVED***
    return result;
***REMOVED***
export function createMessage(type, params, prefix, tags, serverProperties, isServer) ***REMOVED***
    ...
    forEachObjectEntry(type.PARAM_SPEC, function (paramSpec, paramName) ***REMOVED***
...
var Message = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***
    Message.checkParam = function (param, spec, serverProperties) ***REMOVED***
        ...
        if (spec.type === 'channel') ***REMOVED***
            if (!isChannel(param, serverProperties.channelTypes)) ***REMOVED***
                return false;
            ***REMOVED***
        ***REMOVED***
        if (spec.type === 'channelList') ***REMOVED***
            var channels = param.split(',');
            if (!channels.every(function (chan) ***REMOVED*** return isChannel(chan, serverProperties.channelTypes); ***REMOVED***)) ***REMOVED***
                return false;
            ***REMOVED***
        ***REMOVED***
    ...
    ***REMOVED***;
    Message.prototype.tagsToString = function () ***REMOVED***
        return __spread(this._tags.entries()).map(function (_a) ***REMOVED***
    ...
    Message.prototype.parseParams = function (isServer) ***REMOVED***
        ...
        if (this._params) ***REMOVED***
            ...
            ***REMOVED***
            ...
            var parsedParams = ***REMOVED******REMOVED***;
            try ***REMOVED***
                for (var _b = __values(Object.entries(paramSpecList)), _c = _b.next(); !_c.done; _c = _b.next()) ***REMOVED***
                    ...
                    ***REMOVED***
                    if (Message.checkParam(param.value, paramSpec)) ***REMOVED***
                        parsedParams[paramName] = __assign(***REMOVED******REMOVED***, param);
                        if (!paramSpec.optional) ***REMOVED***
                            --requiredParamsLeft;
                        ***REMOVED***
                        if (!paramSpec.rest) ***REMOVED***
    ...
    ***REMOVED***;
    Object.defineProperty(Message.prototype, "params", ***REMOVED***
        get: function () ***REMOVED***
            ...
            var cls = this.constructor;
            var specKeys = Object.keys(cls.PARAM_SPEC);
            return Object.assign.apply(Object, __spread([***REMOVED******REMOVED***], specKeys
                .map(function (paramName) ***REMOVED***
                // TS inference does really not help here... so this is any for now
                // eslint-disable-next-line @typescript-eslint/no-explicit-any
                var param = _this[paramName];
    ...
    ***REMOVED***;
    ...
    return Message;
***REMOVED***());
export ***REMOVED*** Message ***REMOVED***;
