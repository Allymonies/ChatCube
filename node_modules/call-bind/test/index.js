...
var functionsHaveConfigurableLengths = !!(
	...
	&& Object.getOwnPropertyDescriptor(bind.call(function () ***REMOVED******REMOVED***), 'length').configurable
);

test('callBind', function (t) ***REMOVED***
	var sentinel = ***REMOVED*** sentinel: true ***REMOVED***;
	var func = function (a, b) ***REMOVED***
	...
	***REMOVED***;
	...
	t.equal(bound.length, func.length + 1, 'function length is preserved', ***REMOVED*** skip: !functionsHaveConfigurableLengths ***REMOVED***);
	...
	t.equal(boundR.length, func.length, 'function length is preserved', ***REMOVED*** skip: !functionsHaveConfigurableLengths ***REMOVED***);
	t.deepEqual(boundR(), [sentinel, undefined, undefined], 'bound func with receiver, with too few args');
	t.deepEqual(boundR(1, 2), [sentinel, 1, 2], 'bound func with receiver, with right args');
	t.deepEqual(boundR(1, 2, 3), [sentinel, 1, 2], 'bound func with receiver, with too many args');

	var boundArg = callBind(func, sentinel, 1);
	t.equal(boundArg.length, func.length - 1, 'function length is preserved', ***REMOVED*** skip: !functionsHaveConfigurableLengths ***REMOVED***);
	t.deepEqual(boundArg(), [sentinel, 1, undefined], 'bound func with receiver and arg, with too few args');
	t.deepEqual(boundArg(2), [sentinel, 1, 2], 'bound func with receiver and arg, with right arg');
	t.deepEqual(boundArg(2, 3), [sentinel, 1, 2], 'bound func with receiver and arg, with too many args');

	t.test('callBind.apply', function (st) ***REMOVED***
