(function() ***REMOVED***
  ...
  ***REMOVED***;
  ...
  ipaddr.IPv6 = (function() ***REMOVED***
    ...
    ***REMOVED***;
    ...
    IPv6.prototype.toRFC5952String = function() ***REMOVED***
      var bestMatchIndex, bestMatchLength, match, regex, string;
      regex = /((^|:)(0(:|$))***REMOVED***2,***REMOVED***)/g;
      string = this.toNormalizedString();
      bestMatchIndex = 0;
      bestMatchLength = -1;
      while ((match = regex.exec(string))) ***REMOVED***
        if (match[0].length > bestMatchLength) ***REMOVED***
          bestMatchIndex = match.index;
          bestMatchLength = match[0].length;
        ***REMOVED***
      ***REMOVED***
      if (bestMatchLength < 0) ***REMOVED***
        return string;
      ***REMOVED***
    ...
    ***REMOVED***;
    ...
    IPv6.prototype.toFixedLengthString = function() ***REMOVED***
      var addr, part, suffix;
      addr = ((function() ***REMOVED***
        var k, len, ref, results;
        ref = this.parts;
  ...
  ***REMOVED***;
  ...
  ipaddr.IPv4.isValidFourPartDecimal = function(string) ***REMOVED***
    if (ipaddr.IPv4.isValid(string) && string.match(/^(0|[1-9]\d*)(\.(0|[1-9]\d*))***REMOVED***3***REMOVED***$/)) ***REMOVED***
      return true;
    ***REMOVED*** else ***REMOVED***
      return false;
    ***REMOVED***
  ...
  ipaddr.IPv4.parseCIDR = function(string) ***REMOVED***
    ...
    if (match = string.match(/^(.+)\/(\d+)$/)) ***REMOVED***
      ...
      if (maskLength >= 0 && maskLength <= 32) ***REMOVED***
        ...
        Object.defineProperty(parsed, 'toString', ***REMOVED***
