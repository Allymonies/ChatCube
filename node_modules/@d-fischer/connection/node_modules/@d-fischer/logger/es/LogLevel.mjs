...
export function resolveLogLevel(level) ***REMOVED***
    if (typeof level === 'number') ***REMOVED***
        if (Object.prototype.hasOwnProperty.call(LogLevel, level)) ***REMOVED***
            return level;
        ***REMOVED***
        var eligibleLevels = Object.keys(LogLevel)
            .map(function (k) ***REMOVED*** return parseInt(k, 10); ***REMOVED***)
            .filter(function (k) ***REMOVED*** return !isNaN(k) && k < level; ***REMOVED***);
        if (!eligibleLevels.length) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (!Object.prototype.hasOwnProperty.call(LogLevel, strLevel)) ***REMOVED***
...
export var LogLevelToConsoleFunction = (_a = ***REMOVED******REMOVED***,
