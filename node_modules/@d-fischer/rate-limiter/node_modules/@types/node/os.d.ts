declare module 'os' ***REMOVED***
    ...
    ***REMOVED***
    ...
    interface NetworkInterfaceBase ***REMOVED***
        address: string;
        netmask: string;
        mac: string;
        internal: boolean;
    ...
    ***REMOVED***
    ...
    interface NetworkInterfaceInfoIPv4 extends NetworkInterfaceBase ***REMOVED***
        family: "IPv4";
    ***REMOVED***

    interface NetworkInterfaceInfoIPv6 extends NetworkInterfaceBase ***REMOVED***
        family: "IPv6";
        scopeid: number;
    ***REMOVED***

    interface UserInfo<T> ***REMOVED***
        username: T;
        uid: number;
        gid: number;
        shell: T;
    ...
    ***REMOVED***
    ...
    function networkInterfaces(): ***REMOVED*** [index: string]: NetworkInterfaceInfo[] ***REMOVED***;
    function homedir(): string;
    function userInfo(options: ***REMOVED*** encoding: 'buffer' ***REMOVED***): UserInfo<Buffer>;
    function userInfo(options?: ***REMOVED*** encoding: string ***REMOVED***): UserInfo<string>;
    const constants: ***REMOVED***
        UV_UDP_REUSEADDR: number;
        // signals: ***REMOVED*** [key in NodeJS.Signals]: number; ***REMOVED***; @todo: change after migration to typescript 2.1
        signals: ***REMOVED***
            SIGHUP: number;
            SIGINT: number;
            SIGQUIT: number;
