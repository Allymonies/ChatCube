...
module.exports = function ApplyStringOrNumericBinaryOperator(lval, opText, rval) ***REMOVED***
	if (Type(opText) !== 'String' || !HasOwnProperty(table, opText)) ***REMOVED***
	...
	***REMOVED***
	if (opText === '+') ***REMOVED***
		...
		if (Type(lprim) === 'String' || Type(rprim) === 'String') ***REMOVED***
