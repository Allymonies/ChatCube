/// <reference lib="dom" />
import type ***REMOVED*** RequestInit as NodeRequestInit ***REMOVED*** from 'node-fetch';
/**
 * The endpoint to call, i.e. /kraken, /helix or a custom (potentially unsupported) endpoint.
 */
export declare enum TwitchApiCallType ***REMOVED***
    /**
 ...
 */
export interface TwitchApiCallOptions ***REMOVED***
    /**
     * The URL to request.
     *
