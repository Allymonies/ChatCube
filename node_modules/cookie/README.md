...
// ***REMOVED*** foo: 'bar', equation: 'E=mc^2' ***REMOVED***
```
...
function onRequest(req, res) ***REMOVED***
  // Parse the query string
  var query = url.parse(req.url, true, true).query;

  if (query && query.name) ***REMOVED***
    // Set a new cookie with the name
    res.setHeader('Set-Cookie', cookie.serialize('name', String(query.name), ***REMOVED***
      httpOnly: true,
