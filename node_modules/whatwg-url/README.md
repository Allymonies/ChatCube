...
- [URL parser](https://url.spec.whatwg.org/#concept-url-parser): `parseURL(input, ***REMOVED*** baseURL, encodingOverride ***REMOVED***)`
- [Basic URL parser](https://url.spec.whatwg.org/#concept-basic-url-parser): `basicURLParse(input, ***REMOVED*** baseURL, encodingOverride, url, stateOverride ***REMOVED***)`
