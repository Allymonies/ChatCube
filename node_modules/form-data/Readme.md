...
// provide an object.
form.append( 'my_file', fs.createReadStream('/foo/bar.jpg'), ***REMOVED***filename: 'bar.jpg', contentType: 'image/jpeg', knownLength: 19806***REMOVED*** );
```
...
axios.post('http://example.com', form, ***REMOVED***
  headers: ***REMOVED***
    ...formHeaders,
  ***REMOVED***,
***REMOVED***)
