...
FormData.prototype.setBoundary = function(boundary) ***REMOVED***
...
FormData.prototype.getBuffer = function() ***REMOVED***
  var dataBuffer = new Buffer.alloc( 0 );
  var boundary = this.getBoundary();

  // Create the form content. Add Line breaks to the end of data.
  for (var i = 0, len = this._streams.length; i < len; i++) ***REMOVED***
    if (typeof this._streams[i] !== 'function') ***REMOVED***

      // Add content to the buffer.
      if(Buffer.isBuffer(this._streams[i])) ***REMOVED***
      ...
      ***REMOVED***
      ...
      if (typeof this._streams[i] !== 'string' || this._streams[i].substring( 2, boundary.length + 2 ) !== boundary) ***REMOVED***
  ...
  this.getLength(function(err, length) ***REMOVED***
    ...
    ***REMOVED***
    ...
    if (cb) ***REMOVED***
      ...
      var callback = function (error, responce) ***REMOVED***
