...
var ChannelPlaceholder = /** @class */ (function () ***REMOVED***
        ...
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            ...
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 2:
                        e_1 = _a.sent();
                        if (e_1 instanceof NoSubscriptionProgramError) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    ChannelPlaceholder = __decorate([
        rtfm('twitch', 'ChannelPlaceholder', 'id')
    ], ChannelPlaceholder);
    return ChannelPlaceholder;
***REMOVED***());
export ***REMOVED*** ChannelPlaceholder ***REMOVED***;
