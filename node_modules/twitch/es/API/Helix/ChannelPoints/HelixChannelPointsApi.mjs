...
import ***REMOVED*** HelixCustomReward ***REMOVED*** from "./HelixCustomReward.mjs";
import ***REMOVED*** HelixCustomRewardRedemption ***REMOVED*** from "./HelixCustomRewardRedemption.mjs";
/**
        ...
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            ...
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.data.map(function (data) ***REMOVED*** return new HelixCustomReward(data, _this._client); ***REMOVED***)];
                ***REMOVED***
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
        ...
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            ...
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.data.map(function (data) ***REMOVED*** return new HelixCustomRewardRedemption(data, _this._client); ***REMOVED***)];
                ***REMOVED***
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
            ...
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0: return [4 /*yield*/, this._client.callApi(***REMOVED***
                            ...
                            url: 'channel_points/custom_rewards/redemptions',
                            scope: 'channel:read:redemptions',
                            query: __assign(***REMOVED*** broadcaster_id: extractUserId(broadcaster), reward_id: rewardId, status: status, sort: filter.newestFirst ? 'NEWEST' : 'OLDEST' ***REMOVED***, makePaginationQuery(filter))
                        ***REMOVED***)];
                    case 1:
                        result = _a.sent();
    ...
    ***REMOVED***;
    ...
    HelixChannelPointsApi.prototype.getRedemptionsForBroadcasterPaginated = function (broadcaster, rewardId, status, filter) ***REMOVED***
        ...
        return new HelixPaginatedRequest(***REMOVED***
            ...
            ***REMOVED***
    ***REMOVED*** this._client, function (data) ***REMOVED*** return new HelixCustomRewardRedemption(data, _this._client); ***REMOVED***, 50);
    ***REMOVED***;
    /**
...
***REMOVED***(BaseApi));
export ***REMOVED*** HelixChannelPointsApi ***REMOVED***;
