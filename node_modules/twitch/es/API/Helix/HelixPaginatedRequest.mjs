...
var _a;
import ***REMOVED*** __assign, __asyncDelegator, __asyncGenerator, __asyncValues, __await, __awaiter, __decorate, __generator, __read, __spread, __values ***REMOVED*** from "tslib";
...
var HelixPaginatedRequest = /** @class */ (function () ***REMOVED***
    ...
    ***REMOVED***;
    HelixPaginatedRequest.prototype[Symbol.asyncIterator] = function () ***REMOVED***
        return __asyncGenerator(this, arguments, function _a() ***REMOVED***
            var data;
            return __generator(this, function (_b) ***REMOVED***
                switch (_b.label) ***REMOVED***
                    case 0:
    ...
    ***REMOVED***;
    ...
    HelixPaginatedRequest.prototype._fetchData = function (additionalOptions) ***REMOVED***
        ...
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, this._client.callApi(__assign(__assign(__assign(***REMOVED*** type: TwitchApiCallType.Helix ***REMOVED***, this._callOptions), additionalOptions), ***REMOVED*** query: __assign(__assign(__assign(***REMOVED******REMOVED***, this._callOptions.query), ***REMOVED*** after: this._currentCursor, first: this._limitPerPage.toString() ***REMOVED***), additionalOptions.query) ***REMOVED***))];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    /** @private */
...
***REMOVED***());
export ***REMOVED*** HelixPaginatedRequest ***REMOVED***;
