import ***REMOVED*** __assign, __awaiter, __decorate, __generator, __rest ***REMOVED*** from "tslib";
import ***REMOVED*** Cacheable, CachedGetter ***REMOVED*** from '@d-fischer/cache-decorators';
import deprecate from '@d-fischer/deprecate';
import ***REMOVED*** callTwitchApi, callTwitchApiRaw, HttpStatusCodeError, transformTwitchApiResponse, TwitchApiCallType ***REMOVED*** from 'twitch-api-call';
import ***REMOVED*** ClientCredentialsAuthProvider, exchangeCode, getAppToken, getTokenInfo, InvalidTokenError, RefreshableAuthProvider, refreshUserToken, StaticAuthProvider, TokenInfo ***REMOVED*** from 'twitch-auth';
import ***REMOVED*** rtfm ***REMOVED*** from 'twitch-common';
import ***REMOVED*** BadgesApi ***REMOVED*** from "./API/Badges/BadgesApi.mjs";
import ***REMOVED*** HelixApiGroup ***REMOVED*** from "./API/Helix/HelixApiGroup.mjs";
import ***REMOVED*** HelixRateLimiter ***REMOVED*** from "./API/Helix/HelixRateLimiter.mjs";
import ***REMOVED*** KrakenApiGroup ***REMOVED*** from "./API/Kraken/KrakenApiGroup.mjs";
import ***REMOVED*** CheermoteBackground, CheermoteScale, CheermoteState ***REMOVED*** from "./API/Shared/BaseCheermoteList.mjs";
import ***REMOVED*** UnsupportedApi ***REMOVED*** from "./API/Unsupported/UnsupportedApi.mjs";
import ***REMOVED*** ConfigError ***REMOVED*** from "./Errors/ConfigError.mjs";
/**
...
var ApiClient = /** @class */ (function () ***REMOVED***
    ...
    function ApiClient(config) ***REMOVED***
        ...
        ***REMOVED***
        this._helixRateLimiter = new HelixRateLimiter(***REMOVED*** logger: __assign(***REMOVED*** minLevel: config.logLevel ***REMOVED***, config.logger) ***REMOVED***);
        this._config = __assign(***REMOVED*** preAuth: false, cheermotes: ***REMOVED***
    ...
    ***REMOVED***
    ...
    ApiClient.withCredentials = function (clientId, accessToken, scopes, refreshConfig, config, tokenType) ***REMOVED***
        ...
        return new this(__assign(__assign(***REMOVED******REMOVED***, config), ***REMOVED*** authProvider: authProvider ***REMOVED***));
    ***REMOVED***;
    /**
        ...
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            ...
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.callApi(***REMOVED*** type: TwitchApiCallType.Auth, url: 'validate' ***REMOVED***)];
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, new TokenInfo(data)];
                    case 2:
                        e_1 = _a.sent();
                        if (e_1 instanceof HttpStatusCodeError && e_1.statusCode === 401) ***REMOVED***
                ...
                switch (_c.label) ***REMOVED***
                    ...
                    case 3:
                        ...
                        if (!accessToken) ***REMOVED***
                            return [2 /*return*/, callTwitchApi(options, authProvider.clientId, undefined, this._config.fetchOptions)];
                        ***REMOVED***
    ...
    ApiClient.prototype._callApiInternal = function (options, clientId, accessToken) ***REMOVED***
        return __awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return __generator(this, function (_a) ***REMOVED***
                ...
                if (options.type === TwitchApiCallType.Helix) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    return ApiClient;
***REMOVED***());
export ***REMOVED*** ApiClient ***REMOVED***;
