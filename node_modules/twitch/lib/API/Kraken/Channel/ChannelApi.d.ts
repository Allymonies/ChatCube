...
import ***REMOVED*** Team ***REMOVED*** from '../Team/Team';
import ***REMOVED*** User ***REMOVED*** from '../User/User';
import ***REMOVED*** Channel ***REMOVED*** from './Channel';
import ***REMOVED*** ChannelFollow ***REMOVED*** from './ChannelFollow';
import ***REMOVED*** ChannelSubscription ***REMOVED*** from './ChannelSubscription';
import ***REMOVED*** PrivilegedChannel ***REMOVED*** from './PrivilegedChannel';
/**
 * Channel data to update using ***REMOVED***@ChannelApi#updateChannel***REMOVED***.
 */
export interface ChannelUpdateData ***REMOVED***
    /**
 ...
 *
 * Can be accessed using `client.kraken.channels` on an ***REMOVED***@ApiClient***REMOVED*** instance.
 *
 * ## Example
 * ```ts
 ...
 * ```
 */
export declare class ChannelApi extends BaseApi ***REMOVED***
    /**
     ...
     * use ***REMOVED***@UserApi#getSubscriptionData***REMOVED*** instead.
     *
