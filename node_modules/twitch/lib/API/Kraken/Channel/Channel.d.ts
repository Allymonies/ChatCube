import type ***REMOVED*** UserNameResolveableType ***REMOVED*** from 'twitch-common';
import type ***REMOVED*** ApiClient ***REMOVED*** from '../../../ApiClient';
import type ***REMOVED*** Team ***REMOVED*** from '../Team/Team';
import type ***REMOVED*** ChannelUpdateData ***REMOVED*** from './ChannelApi';
import type ***REMOVED*** ChannelPlaceholderData ***REMOVED*** from './ChannelPlaceholder';
import ***REMOVED*** ChannelPlaceholder ***REMOVED*** from './ChannelPlaceholder';
/** @private */
export interface ChannelData extends ChannelPlaceholderData ***REMOVED***
 ...
 * A Twitch Channel.
 */
export declare class Channel extends ChannelPlaceholder implements UserNameResolveableType ***REMOVED***
