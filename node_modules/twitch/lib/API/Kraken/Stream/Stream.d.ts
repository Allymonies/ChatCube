...
import type ***REMOVED*** ChannelData ***REMOVED*** from '../Channel/Channel';
...
/** @private */
export declare type StreamPreviewUrlList = ***REMOVED***
    [size in StreamPreviewSize]: string;
***REMOVED***;
/** @private */
export interface StreamDataWrapper ***REMOVED***
    stream: StreamData | null;
***REMOVED***
/** @private */
export interface StreamData ***REMOVED***
    _id: string | number;
    game: string;
    viewers: number;
    video_height: number;
 ...
 */
export declare enum StreamType ***REMOVED***
    /**
     * A live stream.
     */
    Live = "live",
 ...
 * A Twitch stream.
 */
export declare class Stream ***REMOVED***
