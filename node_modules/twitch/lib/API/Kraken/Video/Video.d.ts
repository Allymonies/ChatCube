...
import type ***REMOVED*** Channel ***REMOVED*** from '../Channel/Channel';
/** @private */
export interface VideoChannelData ***REMOVED***
    _id: string;
    name: string;
    display_name: string;
***REMOVED***
/** @private */
export interface VideoMutedSegment ***REMOVED***
    duration: number;
    offset: number;
***REMOVED***
/** @private */
...
/** @private */
export interface VideoThumbnail ***REMOVED***
    type: string;
    url: string;
***REMOVED***
/** @private */
...
/** @private */
export interface VideoData ***REMOVED***
    _id: string;
    broadcast_id: string;
 ...
 * A Twitch video.
 */
export declare class Video ***REMOVED***
    /** @private */
