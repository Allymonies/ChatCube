...
import ***REMOVED*** CreatedVideo ***REMOVED*** from './CreatedVideo';
import type ***REMOVED*** VideoViewability ***REMOVED*** from './Video';
import ***REMOVED*** Video ***REMOVED*** from './Video';
/**
...
/** @private */
export interface VideoEditData ***REMOVED***
    /**
...
***REMOVED***
/**
 * Video data for a new video using ***REMOVED***@VideoApi#createVideo***REMOVED***.
 */
interface VideoCreateData extends VideoEditData ***REMOVED***
    /**
...
***REMOVED***
/**
 * Video data to update using ***REMOVED***@VideoApi#updateVideo***REMOVED***.
 *
 * @inheritDoc
 */
export interface VideoUpdateData extends VideoEditData ***REMOVED***
    /**
     * The new title of the video.
     */
    title?: string;
 ...
 * ```
 */
export declare class VideoApi extends BaseApi ***REMOVED***
    /**
