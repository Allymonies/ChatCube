...
var VideoApi = /** @class */ (function (_super) ***REMOVED***
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, data.vods.map(function (vod) ***REMOVED*** return new Video_1.Video(vod, _this._client); ***REMOVED***)];
                ***REMOVED***
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
                ...
                switch (_a.label) ***REMOVED***
                    case 0:
                        ...
                        return [4 /*yield*/, this._client.callApi(***REMOVED***
                                ...
                                query: tslib_1.__assign(***REMOVED*** channel_id: channelId ***REMOVED***, createData)
                            ***REMOVED***)];
                    case 1:
                        data = _a.sent();
    ...
    ***REMOVED***;
    ...
    VideoApi.prototype.deleteVideo = function (id) ***REMOVED***
        ...
        ***REMOVED***);
    ***REMOVED***;
    VideoApi = tslib_1.__decorate([
        twitch_common_1.rtfm('twitch', 'VideoApi')
    ], VideoApi);
    return VideoApi;
