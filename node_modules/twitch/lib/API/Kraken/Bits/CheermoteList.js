 ...
 * @inheritDoc
 */
var CheermoteList = /** @class */ (function (_super) ***REMOVED***
    tslib_1.__extends(CheermoteList, _super);
    /** @private */
    function CheermoteList(data, client) ***REMOVED***
        var _this = _super.call(this) || this;
        _this._client = client;
        _this._data = shared_utils_1.indexBy(data, function (action) ***REMOVED*** return action.prefix.toLowerCase(); ***REMOVED***);
        return _this;
    ***REMOVED***
    /**
     ...
     */
    CheermoteList.prototype.getCheermoteDisplayInfo = function (name, bits, format) ***REMOVED***
        var _a, _b, _c;
    ...
    ***REMOVED***;
     ...
     */
    CheermoteList.prototype.getPossibleNames = function () ***REMOVED***
        return Object.keys(this._data);
    ***REMOVED***;
    tslib_1.__decorate([
        shared_utils_1.Enumerable(false)
    ], CheermoteList.prototype, "_data", void 0);
    tslib_1.__decorate([
        shared_utils_1.Enumerable(false)
    ], CheermoteList.prototype, "_client", void 0);
    CheermoteList = tslib_1.__decorate([
        twitch_common_1.rtfm('twitch', 'CheermoteList')
    ], CheermoteList);
    return CheermoteList;
***REMOVED***(BaseCheermoteList_1.BaseCheermoteList));
