...
import type ***REMOVED*** UserData ***REMOVED*** from './User';
import ***REMOVED*** User ***REMOVED*** from './User';
import type ***REMOVED*** UserBlock ***REMOVED*** from './UserBlock';
import type ***REMOVED*** UserFollow ***REMOVED*** from './UserFollow';
/** @private */
export interface UserNotificationFlags ***REMOVED***
    email: boolean;
    push: boolean;
***REMOVED***
/** @private */
export interface PrivilegedUserData extends UserData ***REMOVED***
    email: string;
 ...
 * @inheritDoc
 */
export declare class PrivilegedUser extends User ***REMOVED***
    /** @private */ protected readonly _data: PrivilegedUserData;
    /**
