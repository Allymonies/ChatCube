...
import ***REMOVED*** EmoteSetList ***REMOVED*** from '../Channel/EmoteSetList';
import ***REMOVED*** PrivilegedUser ***REMOVED*** from './PrivilegedUser';
import ***REMOVED*** User ***REMOVED*** from './User';
import ***REMOVED*** UserBlock ***REMOVED*** from './UserBlock';
import ***REMOVED*** UserChatInfo ***REMOVED*** from './UserChatInfo';
import ***REMOVED*** UserFollow ***REMOVED*** from './UserFollow';
import ***REMOVED*** UserSubscription ***REMOVED*** from './UserSubscription';
/**
 ...
 * ```
 */
export declare class UserApi extends BaseApi ***REMOVED***
