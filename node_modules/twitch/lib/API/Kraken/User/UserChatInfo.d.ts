...
import type ***REMOVED*** User ***REMOVED*** from './User';
interface UserChatInfoGlobalBadgeData ***REMOVED***
    id: string;
    version: string;
***REMOVED***
/** @private */
export interface UserChatInfoData ***REMOVED***
    _id: string;
    login: string;
    display_name: string;
    color: string;
 ...
 */
export declare class UserChatInfo ***REMOVED***
