...
import type ***REMOVED*** HelixHypeTrainContributionData ***REMOVED*** from './HelixHypeTrainContribution';
import ***REMOVED*** HelixHypeTrainContribution ***REMOVED*** from './HelixHypeTrainContribution';
/** @private */
export interface HelixHypeTrainEventData ***REMOVED***
    id: string;
 ...
 * A Hype Train event.
 */
export declare class HelixHypeTrainEvent ***REMOVED***
