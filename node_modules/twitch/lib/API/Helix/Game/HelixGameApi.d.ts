...
import type ***REMOVED*** HelixGameData ***REMOVED*** from './HelixGame';
import ***REMOVED*** HelixGame ***REMOVED*** from './HelixGame';
/**
 * The Helix API methods that deal with games.
 *
 * Can be accessed using `client.helix.games` on an ***REMOVED***@ApiClient***REMOVED*** instance.
 *
 * ## Example
 * ```ts
 ...
 * ```
 */
export declare class HelixGameApi extends BaseApi ***REMOVED***
    /**
