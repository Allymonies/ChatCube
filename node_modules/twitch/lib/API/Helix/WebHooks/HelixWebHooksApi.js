    ...
    HelixWebHooksApi.prototype.getSubscriptions = function () ***REMOVED***
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, new HelixPaginatedRequestWithTotal_1.HelixPaginatedRequestWithTotal(***REMOVED***
                        url: 'webhooks/subscriptions'
                ***REMOVED*** this._client, function (data) ***REMOVED*** return new HelixWebHookSubscription_1.HelixWebHookSubscription(data, _this._client); ***REMOVED***)];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    /**
    ...
    HelixWebHooksApi.prototype._sendUserFollowsHubRequest = function (mode, direction, user, options) ***REMOVED***
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                ...
                return [2 /*return*/, this.sendHubRequest(tslib_1.__assign(***REMOVED*** mode: mode, topicUrl: "https://api.twitch.tv/helix/users/follows?first=1&" + direction + "_id=" + userId ***REMOVED***, options))];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    HelixWebHooksApi.prototype._sendHypeTrainEventHubRequest = function (mode, user, options) ***REMOVED***
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                userId = twitch_common_1.extractUserId(user);
                return [2 /*return*/, this.sendHubRequest(tslib_1.__assign(***REMOVED*** mode: mode, topicUrl: "https://api.twitch.tv/helix/hypetrain/events?broadcaster_id=" + userId + "&first=1", scope: 'channel:read:hype_train' ***REMOVED***, options))];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    HelixWebHooksApi.prototype._sendStreamChangeHubRequest = function (mode, user, options) ***REMOVED***
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                userId = twitch_common_1.extractUserId(user);
                return [2 /*return*/, this.sendHubRequest(tslib_1.__assign(***REMOVED*** mode: mode, topicUrl: "https://api.twitch.tv/helix/streams?user_id=" + userId ***REMOVED***, options))];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    HelixWebHooksApi.prototype._sendUserChangeHubRequest = function (mode, user, options, withEmail) ***REMOVED***
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                userId = twitch_common_1.extractUserId(user);
                return [2 /*return*/, this.sendHubRequest(tslib_1.__assign(***REMOVED*** mode: mode, topicUrl: "https://api.twitch.tv/helix/users?id=" + userId, scope: withEmail ? 'user:read:email' : undefined ***REMOVED***, options))];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    HelixWebHooksApi.prototype._sendSubscriptionEventsHubRequest = function (mode, user, options) ***REMOVED***
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                userId = twitch_common_1.extractUserId(user);
                return [2 /*return*/, this.sendHubRequest(tslib_1.__assign(***REMOVED*** mode: mode, topicUrl: "https://api.twitch.tv/helix/subscriptions/events?broadcaster_id=" + userId + "&first=1", scope: 'channel:read:subscriptions' ***REMOVED***, options))];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    HelixWebHooksApi.prototype._sendExtensionTransactionsHubRequest = function (mode, extensionId, options) ***REMOVED***
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, this.sendHubRequest(tslib_1.__assign(***REMOVED*** mode: mode, topicUrl: "https://api.twitch.tv/helix/extensions/transactions?extension_id=" + extensionId + "&first=1" ***REMOVED***, options))];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    HelixWebHooksApi.prototype._sendBanEventsHubRequest = function (mode, broadcaster, options, user) ***REMOVED***
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                ...
                ***REMOVED***
                return [2 /*return*/, this.sendHubRequest(tslib_1.__assign(***REMOVED*** mode: mode,
