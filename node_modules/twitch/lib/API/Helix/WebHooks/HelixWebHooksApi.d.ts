...
import type ***REMOVED*** HelixWebHookSubscriptionData ***REMOVED*** from './HelixWebHookSubscription';
import ***REMOVED*** HelixWebHookSubscription ***REMOVED*** from './HelixWebHookSubscription';
/**
 * The properties describing where and how long a WebHook notification is sent, and how it is signed.
 */
export interface HelixWebHookHubRequestOptions ***REMOVED***
    /**
 ...
 * @inheritDoc
 */
export interface HelixWebHookHubRequest extends HelixWebHookHubRequestOptions ***REMOVED***
    /**
 ...
 * ```
 */
export declare class HelixWebHooksApi extends BaseApi ***REMOVED***
    /**
