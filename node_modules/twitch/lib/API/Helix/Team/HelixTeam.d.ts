...
import type ***REMOVED*** HelixUserRelation ***REMOVED*** from '../Relations/HelixUserRelation';
/** @private */
export interface HelixTeamData ***REMOVED***
    id: string;
    team_name: string;
 ...
 * A Stream Team.
 */
export declare class HelixTeam ***REMOVED***
    /** @private */
