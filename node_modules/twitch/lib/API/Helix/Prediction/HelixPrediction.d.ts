...
import type ***REMOVED*** HelixPredictionOutcomeData ***REMOVED*** from './HelixPredictionOutcome';
import ***REMOVED*** HelixPredictionOutcome ***REMOVED*** from './HelixPredictionOutcome';
/**
 * The different statuses a prediction can have.
 */
export declare type HelixPredictionStatus = 'ACTIVE' | 'RESOLVED' | 'CANCELED' | 'LOCKED';
/** @private */
export interface HelixPredictionData ***REMOVED***
    id: string;
 ...
 */
export declare class HelixPrediction ***REMOVED***
