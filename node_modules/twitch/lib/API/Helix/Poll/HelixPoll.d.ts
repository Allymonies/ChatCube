...
import type ***REMOVED*** HelixPollChoiceData ***REMOVED*** from './HelixPollChoice';
import ***REMOVED*** HelixPollChoice ***REMOVED*** from './HelixPollChoice';
/**
...
/** @private */
export interface HelixPollData ***REMOVED***
    id: string;
 ...
 * A channel poll.
 */
export declare class HelixPoll ***REMOVED***
