...
import ***REMOVED*** HelixBitsLeaderboard ***REMOVED*** from './HelixBitsLeaderboard';
import ***REMOVED*** HelixCheermoteList ***REMOVED*** from './HelixCheermoteList';
/**
 ...
 */
export interface HelixBitsLeaderboardQuery ***REMOVED***
    /**
 ...
 *
 * Can be accessed using `client.helix.bits` on an ***REMOVED***@ApiClient***REMOVED*** instance.
 *
 * ## Example
 * ```ts
 * const api = new ApiClient(new StaticAuthProvider(clientId, accessToken));
 * const leaderboard = await api.helix.bits.getLeaderboard(***REMOVED*** period: 'day' ***REMOVED***);
 * ```
 */
export declare class HelixBitsApi extends BaseApi ***REMOVED***
    /**
