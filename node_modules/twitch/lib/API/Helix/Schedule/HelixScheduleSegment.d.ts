...
/** @private */
export interface HelixScheduleSegmentCategoryData ***REMOVED***
    id: string;
    name: string;
***REMOVED***
/** @private */
export interface HelixScheduleSegmentData ***REMOVED***
    id: string;
    start_time: string;
    end_time: string;
    title: string;
 ...
 */
export declare class HelixScheduleSegment ***REMOVED***
