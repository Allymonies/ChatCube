...
import ***REMOVED*** HelixPaginatedScheduleSegmentRequest ***REMOVED*** from './HelixPaginatedScheduleSegmentRequest';
import ***REMOVED*** HelixSchedule ***REMOVED*** from './HelixSchedule';
import ***REMOVED*** HelixScheduleSegment ***REMOVED*** from './HelixScheduleSegment';
/**
 * Filters for the schedule request.
 */
export interface HelixScheduleFilter ***REMOVED***
    /**
 ...
 * @inheritDoc
 */
export interface HelixPaginatedScheduleFilter extends HelixScheduleFilter, HelixForwardPagination ***REMOVED***
***REMOVED***
/**
 * The result of a schedule request.
 */
export interface HelixPaginatedScheduleResult ***REMOVED***
    /**
...
***REMOVED***
/**
 * Vacation mode settings to update using ***REMOVED***@HelixScheduleApi#updateScheduleSettings***REMOVED***.
 */
interface HelixScheduleSettingsUpdateVacation ***REMOVED***
    /**
...
***REMOVED***
/**
 * Schedule settings to update using ***REMOVED***@HelixScheduleApi#updateScheduleSettings***REMOVED***.
 */
export interface HelixScheduleSettingsUpdate ***REMOVED***
    /**
 ...
 */
export interface HelixCreateScheduleSegmentData ***REMOVED***
    /**
 ...
 */
export interface HelixUpdateScheduleSegmentData ***REMOVED***
    /**
     * The date when the segment starts. Must be in UTC.
     */
    startDate?: string;
 ...
 */
export declare class HelixScheduleApi extends BaseApi ***REMOVED***
    /**
