...
/** @private */
export interface HelixEventSubWebHookTransportData ***REMOVED***
    /**
...
/** @private */
export interface HelixEventSubSubscriptionData ***REMOVED***
    id: string;
 ...
 */
export declare class HelixEventSubSubscription ***REMOVED***
