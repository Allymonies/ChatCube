...
import type ***REMOVED*** HelixPaginatedResultWithTotal ***REMOVED*** from '../HelixPaginatedResult';
import type ***REMOVED*** HelixPagination ***REMOVED*** from '../HelixPagination';
import type ***REMOVED*** HelixEventSubSubscriptionData, HelixEventSubSubscriptionStatus, HelixEventSubWebHookTransportData ***REMOVED*** from './HelixEventSubSubscription';
import ***REMOVED*** HelixEventSubSubscription ***REMOVED*** from './HelixEventSubSubscription';
/**
 * The properties describing where and how long a WebHook notification is sent, and how it is signed.
 */
export interface HelixEventSubWebHookTransportOptions extends HelixEventSubWebHookTransportData ***REMOVED***
    /**
 ...
 * ```
 */
export declare class HelixEventSubApi extends BaseApi ***REMOVED***
    /**
