...
import ***REMOVED*** HelixPaginatedRequestWithTotal ***REMOVED*** from '../HelixPaginatedRequestWithTotal';
import type ***REMOVED*** HelixPaginatedResult, HelixPaginatedResultWithTotal ***REMOVED*** from '../HelixPaginatedResult';
import type ***REMOVED*** HelixForwardPagination ***REMOVED*** from '../HelixPagination';
import ***REMOVED*** HelixInstalledExtensionList ***REMOVED*** from './Extensions/HelixInstalledExtensionList';
import ***REMOVED*** HelixUserExtension ***REMOVED*** from './Extensions/HelixUserExtension';
import type ***REMOVED*** HelixUserExtensionUpdatePayload ***REMOVED*** from './Extensions/HelixUserExtensionUpdatePayload';
import type ***REMOVED*** HelixFollowData, HelixFollowFilter ***REMOVED*** from './HelixFollow';
import ***REMOVED*** HelixFollow ***REMOVED*** from './HelixFollow';
import ***REMOVED*** HelixPrivilegedUser ***REMOVED*** from './HelixPrivilegedUser';
import ***REMOVED*** HelixUser ***REMOVED*** from './HelixUser';
import type ***REMOVED*** HelixUserBlockData ***REMOVED*** from './HelixUserBlock';
import ***REMOVED*** HelixUserBlock ***REMOVED*** from './HelixUserBlock';
/** @private */
export declare enum UserLookupType ***REMOVED***
    Id = "id",
    Login = "login"
***REMOVED***
/**
 * User data to update using ***REMOVED***@HelixUserApi#updateUser***REMOVED***.
 */
export interface HelixUserUpdate ***REMOVED***
    description?: string;
***REMOVED***
/**
 * Additional info for a block to be created.
 */
export interface HelixUserBlockAdditionalInfo ***REMOVED***
    /**
 ...
 * ```
 */
export declare class HelixUserApi extends BaseApi ***REMOVED***
    /**
