...
import type ***REMOVED*** HelixGame ***REMOVED*** from '../Game/HelixGame';
import type ***REMOVED*** HelixTag ***REMOVED*** from '../Tag/HelixTag';
import type ***REMOVED*** HelixUser ***REMOVED*** from '../User/HelixUser';
/**
 * The type of a stream.
 */
export declare enum HelixStreamType ***REMOVED***
    /**
...
***REMOVED***
/** @private */
export interface HelixStreamData ***REMOVED***
    id: string;
    user_id: string;
    user_login: string;
    user_name: string;
 ...
 * A Twitch stream.
 */
export declare class HelixStream ***REMOVED***
