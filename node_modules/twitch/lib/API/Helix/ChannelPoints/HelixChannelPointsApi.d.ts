...
import ***REMOVED*** HelixCustomReward ***REMOVED*** from './HelixCustomReward';
import type ***REMOVED*** HelixCustomRewardRedemptionData, HelixCustomRewardRedemptionStatus, HelixCustomRewardRedemptionTargetStatus ***REMOVED*** from './HelixCustomRewardRedemption';
import ***REMOVED*** HelixCustomRewardRedemption ***REMOVED*** from './HelixCustomRewardRedemption';
/**
 * Data to create a new custom reward.
 */
export interface HelixCreateCustomRewardData ***REMOVED***
    /**
 ...
 * @inheritDoc
 */
export interface HelixUpdateCustomRewardData extends Partial<HelixCreateCustomRewardData> ***REMOVED***
    /**
 ...
 */
export interface HelixCustomRewardRedemptionFilter ***REMOVED***
    /**
 ...
 * @inheritDoc
 */
export interface HelixPaginatedCustomRewardRedemptionFilter extends HelixCustomRewardRedemptionFilter, HelixForwardPagination ***REMOVED***
***REMOVED***
/**
 ...
 * ```
 */
export declare class HelixChannelPointsApi extends BaseApi ***REMOVED***
    /**
