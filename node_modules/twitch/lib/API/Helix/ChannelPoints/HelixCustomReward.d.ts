...
/** @private */
export interface HelixCustomRewardImageData ***REMOVED***
    url_1x: string;
    url_2x: string;
    url_4x: string;
***REMOVED***
/** @private */
export interface HelixCustomRewardMaxPerStreamSettingData ***REMOVED***
    is_enabled: boolean;
    max_per_stream: number;
***REMOVED***
/** @private */
export interface HelixCustomRewardMaxPerUserPerStreamSettingData ***REMOVED***
    is_enabled: boolean;
    max_per_user_per_stream: number;
***REMOVED***
/** @private */
export interface HelixCustomRewardGlobalCooldownSettingData ***REMOVED***
    is_enabled: boolean;
...
/** @private */
export interface HelixCustomRewardData ***REMOVED***
 ...
 */
export declare class HelixCustomReward ***REMOVED***
