...
import type ***REMOVED*** HelixCustomReward ***REMOVED*** from './HelixCustomReward';
/**
...
/** @private */
export interface HelixCustomRewardRedemptionRewardData ***REMOVED***
    id: string;
    title: string;
    prompt: string;
    cost: number;
***REMOVED***
/** @private */
export interface HelixCustomRewardRedemptionData ***REMOVED***
 ...
 */
export declare class HelixCustomRewardRedemption ***REMOVED***
