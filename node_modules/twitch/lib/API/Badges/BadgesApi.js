...
var BadgesApi = /** @class */ (function (_super) ***REMOVED***
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    ...
                    case 1:
                        data = _a.sent();
                        return [2 /*return*/, new ChatBadgeList_1.ChatBadgeList(data.badge_sets)];
                ***REMOVED***
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    ...
    BadgesApi.prototype.getChannelBadges = function (channel, includeGlobal, language) ***REMOVED***
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () ***REMOVED***
            ...
            return tslib_1.__generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0: return [4 /*yield*/, this._client.callApi(***REMOVED***
                            url: "https://badges.twitch.tv/v1/badges/channels/" + twitch_common_1.extractUserId(channel) + "/display",
                            query: ***REMOVED***
                                language: language
                        ***REMOVED***
                            type: twitch_api_call_1.TwitchApiCallType.Custom
                    ...
                    case 1:
                        data = _a.sent();
                        channelBadges = new ChatBadgeList_1.ChatBadgeList(data.badge_sets);
    ...
    ***REMOVED***;
    ...
    BadgesApi = tslib_1.__decorate([
        ...
        twitch_common_1.rtfm('twitch', 'BadgesApi')
    ], BadgesApi);
    return BadgesApi;
