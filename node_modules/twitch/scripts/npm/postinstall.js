...
const ***REMOVED*** getTopPackageDependencies ***REMOVED*** = require('top-package');
...
if (!argv || !argv.remain || !argv.remain.length) ***REMOVED***
...
if (!dependencies || (!dependencies['twitch-chat-client'] && !dependencies['twitch-pubsub-client'])) ***REMOVED***
