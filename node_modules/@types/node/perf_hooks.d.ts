declare module 'perf_hooks' ***REMOVED***
    import ***REMOVED*** AsyncResource ***REMOVED*** from 'async_hooks';

    type EntryType = 'node' | 'mark' | 'measure' | 'gc' | 'function' | 'http2' | 'http';

    interface PerformanceEntry ***REMOVED***
        /**
    ...
    ***REMOVED***
    ...
    interface PerformanceNodeTiming extends PerformanceEntry ***REMOVED***
        /**
    ...
    ***REMOVED***
    ...
    class PerformanceObserver extends AsyncResource ***REMOVED***
         ...
         * @param options
         */
        observe(options: ***REMOVED*** entryTypes: ReadonlyArray<EntryType>; buffered?: boolean | undefined ***REMOVED***): void;
    ***REMOVED***
    ...
    ***REMOVED***
    ...
    interface EventLoopDelayMonitor ***REMOVED***
        /**
