declare module 'worker_threads' ***REMOVED***
    import ***REMOVED*** Context ***REMOVED*** from 'vm';
    import EventEmitter = require('events');
    import ***REMOVED*** Readable, Writable ***REMOVED*** from 'stream';
    import ***REMOVED*** URL ***REMOVED*** from 'url';
    import ***REMOVED*** FileHandle ***REMOVED*** from 'fs/promises';
    ...
    ***REMOVED***
     ...
     * `MessagePort`’s queue.
     */
    function receiveMessageOnPort(port: MessagePort): ***REMOVED*** message: any ***REMOVED*** | undefined;
***REMOVED***
