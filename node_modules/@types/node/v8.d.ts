declare module 'v8' ***REMOVED***
    import ***REMOVED*** Readable ***REMOVED*** from 'stream';
    ...
    ***REMOVED***
     ...
     * `'Heap-$***REMOVED***yyyymmdd***REMOVED***-$***REMOVED***hhmmss***REMOVED***-$***REMOVED***pid***REMOVED***-$***REMOVED***thread_id***REMOVED***.heapsnapshot'` will be
     * generated, where `***REMOVED***pid***REMOVED***` will be the PID of the Node.js process,
     * `***REMOVED***thread_id***REMOVED***` will be `0` when `writeHeapSnapshot()` is called from
    ...
    ***REMOVED***
     ...
     */
    class DefaultSerializer extends Serializer ***REMOVED***
    ***REMOVED***
    ...
    ***REMOVED***
     ...
     * and only stores the part of their underlying `ArrayBuffers` that they are referring to.
     */
    class DefaultDeserializer extends Deserializer ***REMOVED***
    ***REMOVED***
