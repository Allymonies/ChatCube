 ...
 */
export interface ChatSubInfo ***REMOVED***
    /**
 ...
 * @inheritDoc
 */
export interface ChatSubGiftInfo extends ChatSubInfo ***REMOVED***
    /**
 ...
 */
export interface ChatSubUpgradeInfo ***REMOVED***
    /**
     * The user ID of the subscribing user.
     */
    userId: string;
 ...
 * @inheritDoc
 */
export interface ChatSubGiftUpgradeInfo extends ChatSubUpgradeInfo ***REMOVED***
    /**
 ...
 */
export interface ChatSubExtendInfo ***REMOVED***
    /**
     * The user ID of the subscribing user.
     */
    userId: string;
