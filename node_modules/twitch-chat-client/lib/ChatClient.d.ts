...
import ***REMOVED*** LogLevel ***REMOVED*** from '@d-fischer/logger';
...
import type ***REMOVED*** WebSocketConnectionOptions ***REMOVED*** from 'ircv3';
import ***REMOVED*** IrcClient ***REMOVED*** from 'ircv3';
import type ***REMOVED*** CommercialLength ***REMOVED*** from 'twitch';
import type ***REMOVED*** AuthProvider ***REMOVED*** from 'twitch-auth';
import ***REMOVED*** UserNotice ***REMOVED*** from './Capabilities/TwitchCommandsCapability/MessageTypes/UserNotice';
import ***REMOVED*** Whisper ***REMOVED*** from './Capabilities/TwitchCommandsCapability/MessageTypes/Whisper';
import ***REMOVED*** ClearMsg ***REMOVED*** from './Capabilities/TwitchTagsCapability/MessageTypes/ClearMsg';
import type ***REMOVED*** ChatSayMessageAttributes ***REMOVED*** from './ChatMessageAttributes';
import ***REMOVED*** TwitchPrivateMessage ***REMOVED*** from './StandardCommands/TwitchPrivateMessage';
import type ***REMOVED*** ChatBitsBadgeUpgradeInfo ***REMOVED*** from './UserNotices/ChatBitsBadgeUpgradeInfo';
import type ***REMOVED*** ChatCommunityPayForwardInfo ***REMOVED*** from './UserNotices/ChatCommunityPayForwardInfo';
import type ***REMOVED*** ChatCommunitySubInfo ***REMOVED*** from './UserNotices/ChatCommunitySubInfo';
import type ***REMOVED*** ChatPrimeCommunityGiftInfo ***REMOVED*** from './UserNotices/ChatPrimeCommunityGiftInfo';
import type ***REMOVED*** ChatRaidInfo ***REMOVED*** from './UserNotices/ChatRaidInfo';
import type ***REMOVED*** ChatRewardGiftInfo ***REMOVED*** from './UserNotices/ChatRewardGiftInfo';
import type ***REMOVED*** ChatRitualInfo ***REMOVED*** from './UserNotices/ChatRitualInfo';
import type ***REMOVED*** ChatStandardPayForwardInfo ***REMOVED*** from './UserNotices/ChatStandardPayForwardInfo';
import type ***REMOVED*** ChatSubExtendInfo, ChatSubGiftInfo, ChatSubGiftUpgradeInfo, ChatSubInfo, ChatSubUpgradeInfo ***REMOVED*** from './UserNotices/ChatSubInfo';
/**
 ...
 */
export interface BaseChatClientOptions ***REMOVED***
    /**
...
***REMOVED***
export interface WebSocketChatClientOptions extends BaseChatClientOptions ***REMOVED***
    webSocket?: true;
    connectionOptions?: WebSocketConnectionOptions;
***REMOVED***
export interface TcpChatClientOptions extends BaseChatClientOptions ***REMOVED***
    webSocket: false;
    connectionOptions?: never;
***REMOVED***
export declare type ChatClientOptions = WebSocketChatClientOptions | TcpChatClientOptions;
/** @private */
export interface ChatMessageRequest ***REMOVED***
    type: 'say' | 'action';
    channel: string;
    message: string;
...
***REMOVED***
/** @private */
export interface WhisperRequest ***REMOVED***
    target: string;
    message: string;
***REMOVED***
/**
 ...
 * @hideProtected
 */
export declare class ChatClient extends IrcClient ***REMOVED***
    ...
    private readonly _whisperRateLimiter;
    private _needToShowWhisperWarning;
    /**
     ...
     * @param channel The channel to end the host on. Defaults to the channel of the connected user.
     */
    unhostOutside(channel?: string): Promise<void>;
    /**
     ...
     */
    deleteMessage(channel: string, message: string | TwitchPrivateMessage): Promise<void>;
    /**
     ...
     */
    say(channel: string, message: string, attributes?: ChatSayMessageAttributes): Promise<void>;
    /**
     ...
     * @param message The message to send.
     */
    action(channel: string, message: string): Promise<void>;
    /**
     ...
     * @param message The message to send.
     */
    whisper(user: string, message: string): Promise<void>;
    /**
     * Joins a channel.
     *
