...
import ***REMOVED*** Logger, LogLevel ***REMOVED*** from '@d-fischer/logger';
import ***REMOVED*** NullRateLimiter, PartitionedTimeBasedRateLimiter, TimeBasedRateLimiter, TimedPassthruRateLimiter ***REMOVED*** from '@d-fischer/rate-limiter';
import ***REMOVED*** delay, Enumerable ***REMOVED*** from '@d-fischer/shared-utils';
import ***REMOVED*** IrcClient, MessageTypes ***REMOVED*** from 'ircv3';
import ***REMOVED*** getTokenInfo, InvalidTokenError, InvalidTokenTypeError ***REMOVED*** from 'twitch-auth';
import ***REMOVED*** rtfm ***REMOVED*** from 'twitch-common';
import ***REMOVED*** TwitchCommandsCapability ***REMOVED*** from "./Capabilities/TwitchCommandsCapability/index.mjs";
import ***REMOVED*** ClearChat ***REMOVED*** from "./Capabilities/TwitchCommandsCapability/MessageTypes/ClearChat.mjs";
import ***REMOVED*** HostTarget ***REMOVED*** from "./Capabilities/TwitchCommandsCapability/MessageTypes/HostTarget.mjs";
import ***REMOVED*** RoomState ***REMOVED*** from "./Capabilities/TwitchCommandsCapability/MessageTypes/RoomState.mjs";
import ***REMOVED*** UserNotice ***REMOVED*** from "./Capabilities/TwitchCommandsCapability/MessageTypes/UserNotice.mjs";
import ***REMOVED*** Whisper ***REMOVED*** from "./Capabilities/TwitchCommandsCapability/MessageTypes/Whisper.mjs";
import ***REMOVED*** TwitchMembershipCapability ***REMOVED*** from "./Capabilities/TwitchMembershipCapability.mjs";
import ***REMOVED*** TwitchTagsCapability ***REMOVED*** from "./Capabilities/TwitchTagsCapability/index.mjs";
import ***REMOVED*** ClearMsg ***REMOVED*** from "./Capabilities/TwitchTagsCapability/MessageTypes/ClearMsg.mjs";
import ***REMOVED*** extractMessageId ***REMOVED*** from "./ChatMessageAttributes.mjs";
import ***REMOVED*** TwitchPrivateMessage ***REMOVED*** from "./StandardCommands/TwitchPrivateMessage.mjs";
import ***REMOVED*** toChannelName, toUserName ***REMOVED*** from "./Toolkit/UserTools.mjs";
 ...
 * @hideProtected
 */
var ChatClient = /** @class */ (function (_super) ***REMOVED***
     ...
     * @expandParams
     *
     * @param authProvider The ***REMOVED***@AuthProvider***REMOVED*** instance to use for authentication.
     * @param options
     */
    function ChatClient(authProvider, options) ***REMOVED***
        if (options === void 0) ***REMOVED*** options = ***REMOVED******REMOVED***; ***REMOVED***
        var _a, _b, _c, _d, _e, _f;
        var _this = _super.call(this, ***REMOVED***
            connection: ***REMOVED***
        ...
        ***REMOVED***
            ...
            logger: __assign(***REMOVED*** minLevel: options.logLevel ***REMOVED***, ((_e = options.logger) !== null && _e !== void 0 ? _e : ***REMOVED******REMOVED***)),
        ...
        ***REMOVED***) || this;
        ...
        if ((authProvider === null || authProvider === void 0 ? void 0 : authProvider.tokenType) === 'app') ***REMOVED***
        ...
        ***REMOVED***
        _this._chatLogger = new Logger(__assign(***REMOVED*** name: 'twitch-chat', emoji: true, minLevel: options.logLevel ***REMOVED***, ((_f = options.logger) !== null && _f !== void 0 ? _f : ***REMOVED******REMOVED***)));
        _this._authProvider = authProvider;
        _this._useLegacyScopes = !!options.legacyScopes;
        _this._readOnly = !!options.readOnly;
        var executeChatMessageRequest = function (_a) ***REMOVED***
            ...
            ***REMOVED***);
        ***REMOVED***;
        var executeJoinRequest = function (channel) ***REMOVED*** return __awaiter(_this, void 0, void 0, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        // eslint-disable-next-line @typescript-eslint/init-declarations
                        var timer;
                        var e = _this._onJoinResult(function (chan, state, error) ***REMOVED***
                            if (chan === channel) ***REMOVED***
                                clearTimeout(timer);
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
            ...
            ***REMOVED***);
        ***REMOVED***); ***REMOVED***;
        var executeWhisperRequest = function (_a) ***REMOVED***
            var target = _a.target, message = _a.message;
            return __awaiter(_this, void 0, void 0, function () ***REMOVED*** return __generator(this, function (_b) ***REMOVED***
                return [2 /*return*/, this._doWhisper(target, message)];
            ***REMOVED***); ***REMOVED***);
        ***REMOVED***;
        if (options.botLevel) ***REMOVED***
            if (options.isAlwaysMod) ***REMOVED***
                _this._messageRateLimiter = new TimeBasedRateLimiter(***REMOVED***
            ...
            ***REMOVED***
                ...
                var bucketSize = 20;
                if (options.botLevel === 'verified') ***REMOVED***
                    bucketSize = 7500;
                ***REMOVED***
                else if (options.botLevel === 'known') ***REMOVED***
                    bucketSize = 50;
                ***REMOVED***
                _this._messageRateLimiter = new TimedPassthruRateLimiter(new PartitionedTimeBasedRateLimiter(***REMOVED***
                    bucketSize: 1,
                    timeFrame: 1200,
                    logger: ***REMOVED*** minLevel: LogLevel.ERROR ***REMOVED***,
                    doRequest: executeChatMessageRequest,
                    getPartitionKey: function (_a) ***REMOVED***
                        var channel = _a.channel;
                        return channel;
                    ***REMOVED***
                ***REMOVED***), ***REMOVED*** bucketSize: bucketSize, timeFrame: 32000 ***REMOVED***);
            ***REMOVED***
            _this._joinRateLimiter = new TimeBasedRateLimiter(***REMOVED***
            ...
            ***REMOVED***
            _this._whisperRateLimiter = new TimedPassthruRateLimiter(new TimeBasedRateLimiter(***REMOVED***
                bucketSize: whisperLimitPerSecond,
                timeFrame: 1200,
                logger: ***REMOVED*** minLevel: LogLevel.ERROR ***REMOVED***,
                doRequest: executeWhisperRequest
            ***REMOVED***), ***REMOVED*** bucketSize: whisperLimitPerMinute, timeFrame: 64000 ***REMOVED***);
        ***REMOVED***
        else ***REMOVED***
        ...
        ***REMOVED***
        ...
        if (options.requestMembershipEvents) ***REMOVED***
            _this.addCapability(TwitchMembershipCapability);
        ***REMOVED***
        _this.addInternalListener(_this.onRegister, function () ***REMOVED***
            _this._authVerified = true;
            _this._authFailureMessage = undefined;
        ***REMOVED***);
        _this.addInternalListener(_this.onPrivmsg, function (channel, user, message, msg) ***REMOVED***
            if (user === 'jtv') ***REMOVED***
                // 1 = who hosted
                // 2 = auto-host or not
        ...
        ***REMOVED***);
        _this.onTypedMessage(ClearChat, function (_a) ***REMOVED***
            ...
            ***REMOVED***
        ***REMOVED***);
        _this.onTypedMessage(ClearMsg, function (msg) ***REMOVED***
        ...
        ***REMOVED***);
        _this.onTypedMessage(HostTarget, function (_a) ***REMOVED***
        ...
        _this.onTypedMessage(RoomState, function (_a) ***REMOVED***
            ...
            ***REMOVED***
            if (tags.has('slow')) ***REMOVED***
                ...
                ***REMOVED***
            ***REMOVED***
            if (tags.has('followers-only')) ***REMOVED***
                var followDelay = Number(tags.get('followers-only'));
                if (followDelay === -1) ***REMOVED***
            ...
            ***REMOVED***
        ***REMOVED***);
        _this.onTypedMessage(UserNotice, function (userNotice) ***REMOVED***
                ...
                ***REMOVED***
                ...
                case 'submysterygift': ***REMOVED***
                    ...
                    ***REMOVED***;
                    ...
                    break;
                ***REMOVED***
                case 'primepaidupgrade': ***REMOVED***
                    var upgradeInfo = ***REMOVED***
                        userId: tags.get('user-id'),
                        displayName: tags.get('display-name'),
                        plan: tags.get('msg-param-sub-plan')
                    ***REMOVED***;
                ...
                ***REMOVED***
                case 'standardpayforward': ***REMOVED***
                    ...
                    ***REMOVED***;
                    ...
                    break;
                ***REMOVED***
                case 'communitypayforward': ***REMOVED***
                    var wasAnon = tags.get('msg-param-prior-gifter-anonymous') === 'true';
                    var forwardInfo = ***REMOVED***
                        userId: tags.get('user-id'),
                        displayName: tags.get('display-name'),
                    ...
                    ***REMOVED***;
                    ...
                    break;
                ***REMOVED***
                case 'primecommunitygiftreceived': ***REMOVED***
                    var giftInfo = ***REMOVED***
                ...
                ***REMOVED***
                case 'ritual': ***REMOVED***
                    ...
                    ***REMOVED***;
                    ...
                    break;
                ***REMOVED***
                case 'bitsbadgetier': ***REMOVED***
                    var badgeUpgradeInfo = ***REMOVED***
                        displayName: tags.get('display-name'),
                    ...
                    ***REMOVED***;
                    ...
                    break;
                ***REMOVED***
                case 'extendsub': ***REMOVED***
                    var extendInfo = ***REMOVED***
                        userId: tags.get('user-id'),
                        displayName: tags.get('display-name'),
                        plan: tags.get('msg-param-sub-plan'),
                        months: Number(tags.get('msg-param-cumulative-months')),
                    ...
                    ***REMOVED***;
                    ...
                    break;
                ***REMOVED***
                case 'rewardgift': ***REMOVED***
                    var rewardGiftInfo = ***REMOVED***
            ...
            ***REMOVED***
        ***REMOVED***);
        _this.onTypedMessage(Whisper, function (whisper) ***REMOVED***
            _this.emit(_this.onWhisper, whisper.prefix.nick, whisper.params.message, whisper);
        ***REMOVED***);
        _this.onTypedMessage(MessageTypes.Commands.Notice, function (_a) ***REMOVED***
            ...
            return __awaiter(_this, void 0, void 0, function () ***REMOVED***
                ...
                return __generator(this, function (_f) ***REMOVED***
                    switch (_f.label) ***REMOVED***
                        ...
                        case 54:
                            ...
                            if (!this._authRetryTimer) ***REMOVED***
                        ...
                        case 58:
                            ***REMOVED***
                                if (!messageType || messageType.substr(0, 6) !== 'usage_') ***REMOVED***
    ...
    ***REMOVED***
    ...
    /**
     * Creates a new Twitch chat client with the user info from the ***REMOVED***@AuthProvider***REMOVED*** instance.
     *
     * @deprecated Use the ***REMOVED***@ChatClient***REMOVED*** constructor instead.
     *
     * @expandParams
     *
     * @param authProvider The ***REMOVED***@AuthProvider***REMOVED*** instance to use for authentication.
     * @param options
     */
    ChatClient.forTwitchClient = function (authProvider, options) ***REMOVED***
        if (options === void 0) ***REMOVED*** options = ***REMOVED******REMOVED***; ***REMOVED***
    ...
    ***REMOVED***;
     ...
     * @param options
     */
    ChatClient.anonymous = function (options) ***REMOVED***
        if (options === void 0) ***REMOVED*** options = ***REMOVED******REMOVED***; ***REMOVED***
        return new this(undefined, options);
    ***REMOVED***;
    ChatClient.prototype.connect = function () ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0:
                        if (!this._authProvider) ***REMOVED***
                            this._updateCredentials(***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.host = function (channel, target) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var channelName;
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onHostResult(function (chan, error) ***REMOVED***
                            if (toUserName(chan) === channelName) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
                                else ***REMOVED***
    ...
    ***REMOVED***;
     ...
     *
     * If you don't need this feedback, consider using ***REMOVED***@ChatClient#unhostOutside***REMOVED*** instead.
     *
     * @param channel The channel to end the host on. Defaults to the channel of the connected user.
     */
    ChatClient.prototype.unhost = function (channel) ***REMOVED***
        if (channel === void 0) ***REMOVED*** channel = this._credentials.nick; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onUnhostResult(function (chan, error) ***REMOVED***
                            if (toUserName(chan) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
                                else ***REMOVED***
    ...
    ***REMOVED***;
     ...
     *
     * If you need feedback about success, use ***REMOVED***@ChatClient#unhost***REMOVED*** (but make sure you're in the channel you are hosting).
     *
     * @param channel The channel to end the host on. Defaults to the channel of the connected user.
     */
    ChatClient.prototype.unhostOutside = function (channel) ***REMOVED***
        if (channel === void 0) ***REMOVED*** channel = this._credentials.nick; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.raid = function (channel, target) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                target = toUserName(target);
                return [2 /*return*/, this.say(channel !== null && channel !== void 0 ? channel : this._credentials.nick, "/raid " + target)];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    /**
     ...
     */
    ChatClient.prototype.unraid = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, this.say(channel !== null && channel !== void 0 ? channel : this._credentials.nick, '/unraid')];
            ***REMOVED***);
        ***REMOVED***);
    ***REMOVED***;
    /**
     ...
     */
    ChatClient.prototype.ban = function (channel, user, reason) ***REMOVED***
        if (reason === void 0) ***REMOVED*** reason = ''; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var channelName;
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onBanResult(function (_channel, _user, error) ***REMOVED***
                            if (toUserName(_channel) === channelName && toUserName(_user) === user) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
                                else ***REMOVED***
    ...
    ***REMOVED***;
     ...
     * @param channel The channel to ban the user from. Defaults to the channel of the connected user.
     */
    ChatClient.prototype.clear = function (channel) ***REMOVED***
        if (channel === void 0) ***REMOVED*** channel = this._credentials.nick; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                ...
                return [2 /*return*/, new Promise(function (resolve) ***REMOVED***
                        var e = _this.addInternalListener(_this.onChatClear, function (_channel) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                resolve();
                                e.unbind();
                            ***REMOVED***
                        ***REMOVED***);
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.changeColor = function (color) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onColorResult(function (error) ***REMOVED***
                            if (error) ***REMOVED***
                                reject(error);
                            ***REMOVED***
                            else ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.runCommercial = function (channel, duration) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onCommercialResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.deleteMessage = function (channel, message) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var messageId;
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onDeleteMessageResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.enableEmoteOnly = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onEmoteOnlyResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.disableEmoteOnly = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onEmoteOnlyOffResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.enableFollowersOnly = function (channel, minFollowTime) ***REMOVED***
        if (minFollowTime === void 0) ***REMOVED*** minFollowTime = 0; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                if (!Number.isInteger(minFollowTime) || minFollowTime < 0 || minFollowTime > 129600) ***REMOVED***
                    throw new Error("Invalid minimum follow time: " + minFollowTime + ". It must be an integer between 0 and 129600.");
                ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onFollowersOnlyResult(function (_channel, _minFollowTime, error) ***REMOVED***
                            if (toUserName(_channel) === channel && _minFollowTime === minFollowTime) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
                                else ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.disableFollowersOnly = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onFollowersOnlyOffResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.mod = function (channel, user) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                user = toUserName(user);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onModResult(function (_channel, _user, error) ***REMOVED***
                            if (toUserName(_channel) === channel && toUserName(_user) === user) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
                                else ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.unmod = function (channel, user) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                user = toUserName(user);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onUnmodResult(function (_channel, _user, error) ***REMOVED***
                            if (toUserName(_channel) === channel && toUserName(_user) === user) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.getMods = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve) ***REMOVED***
                        var e = _this._onModsResult(function (_channel, mods) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                resolve(mods);
                                _this.removeListener(e);
                            ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.enableR9k = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onR9kResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.disableR9k = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onR9kOffResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.enableSlow = function (channel, delayBetweenMessages) ***REMOVED***
        if (delayBetweenMessages === void 0) ***REMOVED*** delayBetweenMessages = 30; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                if (!Number.isInteger(delayBetweenMessages) || delayBetweenMessages < 1 || delayBetweenMessages > 1800) ***REMOVED***
                    throw new Error("Invalid delay between messages: " + delayBetweenMessages + ". It must be an integer between 1 and 1800.");
                ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onSlowResult(function (_channel, _delay, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.disableSlow = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onSlowOffResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.enableSubsOnly = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onSubsOnlyResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.disableSubsOnly = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onSubsOnlyOffResult(function (_channel, error) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     * @param reason
     */
    ChatClient.prototype.timeout = function (channel, user, duration, reason) ***REMOVED***
        if (duration === void 0) ***REMOVED*** duration = 60; ***REMOVED***
        if (reason === void 0) ***REMOVED*** reason = ''; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                if (!Number.isInteger(duration) || duration < 1 || duration > 1209600) ***REMOVED***
                    throw new Error("Invalid timeout duration: " + duration + ". It must be an integer between 1 and 1209600.");
                ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onTimeoutResult(function (_channel, _user, _duration, error) ***REMOVED***
                            if (toUserName(_channel) === channel && toUserName(_user) === user) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.purge = function (channel, user, reason) ***REMOVED***
        if (reason === void 0) ***REMOVED*** reason = ''; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.addVip = function (channel, user) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                user = toUserName(user);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onVipResult(function (_channel, _user, error) ***REMOVED***
                            if (toUserName(_channel) === channel && toUserName(_user) === user) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.removeVip = function (channel, user) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                user = toUserName(user);
                return [2 /*return*/, new Promise(function (resolve, reject) ***REMOVED***
                        var e = _this._onUnvipResult(function (_channel, _user, error) ***REMOVED***
                            if (toUserName(_channel) === channel && toUserName(_user) === user) ***REMOVED***
                                if (error) ***REMOVED***
                                    reject(error);
                                ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.getVips = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                channel = toUserName(channel);
                return [2 /*return*/, new Promise(function (resolve) ***REMOVED***
                        var e = _this._onVipsResult(function (_channel, vips) ***REMOVED***
                            if (toUserName(_channel) === channel) ***REMOVED***
                                resolve(vips);
                                _this.removeListener(e);
                            ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.say = function (channel, message, attributes) ***REMOVED***
        if (attributes === void 0) ***REMOVED*** attributes = ***REMOVED******REMOVED***; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var tags;
            return __generator(this, function (_a) ***REMOVED***
                tags = ***REMOVED******REMOVED***;
                if (attributes.replyTo) ***REMOVED***
                    tags['reply-parent-msg-id'] = extractMessageId(attributes.replyTo);
                ***REMOVED***
                return [2 /*return*/, this._messageRateLimiter.request(***REMOVED***
                        type: 'say',
    ...
    ***REMOVED***;
     ...
     * @param message The message to send.
     */
    ChatClient.prototype.action = function (channel, message) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                return [2 /*return*/, this._messageRateLimiter.request(***REMOVED***
                        type: 'action',
    ...
    ***REMOVED***;
     ...
     * @param message The message to send.
     */
    ChatClient.prototype.whisper = function (user, message) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
                if (this._needToShowWhisperWarning) ***REMOVED***
                ...
                ***REMOVED***
                return [2 /*return*/, this._whisperRateLimiter.request(***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.join = function (channel) ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            return __generator(this, function (_a) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.part = function (channel) ***REMOVED***
        _super.prototype.part.call(this, toChannelName(channel));
    ***REMOVED***;
    /**
     * Disconnects from the chat server.
     */
    ChatClient.prototype.quit = function () ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
    ...
    ***REMOVED***;
     ...
     */
    ChatClient.prototype.waitForRegistration = function () ***REMOVED***
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var authListener;
            var _this = this;
            return __generator(this, function (_a) ***REMOVED***
                switch (_a.label) ***REMOVED***
                    case 0:
                        ...
                        if (this._registered) ***REMOVED***
                            return [2 /*return*/];
                        ***REMOVED***
                        if (this._authFailureMessage) ***REMOVED***
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Promise.race([
                                new Promise(function (resolve, reject) ***REMOVED***
                                    authListener = _this.addInternalListener(_this.onAuthenticationFailure, function (message) ***REMOVED***
        ...
        ***REMOVED***);
    ***REMOVED***;
    ChatClient.prototype.registerCoreMessageTypes = function () ***REMOVED***
        _super.prototype.registerCoreMessageTypes.call(this);
        this.registerMessageType(TwitchPrivateMessage);
    ***REMOVED***;
    ChatClient.prototype.getPassword = function () ***REMOVED***
        var _a, _b;
        return __awaiter(this, void 0, Promise, function () ***REMOVED***
            var scopes, lastTokenError, _c, token, e_1, _d, token, e_2;
            return __generator(this, function (_e) ***REMOVED***
                switch (_e.label) ***REMOVED***
                    case 0:
                        if (!this._authProvider) ***REMOVED***
                            return [2 /*return*/, undefined];
                        ***REMOVED***
                        if (this._authToken && !this._authToken.isExpired && this._authVerified) ***REMOVED***
                    ...
                    case 5:
                        e_1 = _e.sent();
                        if (e_1 instanceof InvalidTokenError) ***REMOVED***
                            lastTokenError = e_1;
                        ***REMOVED***
                        else ***REMOVED***
                    ...
                    case 11:
                        e_2 = _e.sent();
                        if (e_2 instanceof InvalidTokenError) ***REMOVED***
                            lastTokenError = e_2;
                        ***REMOVED***
                        else ***REMOVED***
        ...
        ***REMOVED***);
    ***REMOVED***;
    ChatClient.prototype._doWhisper = function (user, message) ***REMOVED***
        _super.prototype.say.call(this, GENERIC_CHANNEL, "/w " + user + " " + message);
    ***REMOVED***;
    ChatClient.prototype._getNecessaryScopes = function () ***REMOVED***
        if (this._useLegacyScopes) ***REMOVED***
            return ['chat_login'];
        ***REMOVED***
        if (this._readOnly) ***REMOVED***
            return ['chat:read'];
        ***REMOVED***
        return ['chat:read', 'chat:edit'];
    ***REMOVED***;
    ChatClient._generateJustinfanNick = function () ***REMOVED***
    ...
    ***REMOVED***;
    ...
    ChatClient._getReauthenticateWaitTime = function () ***REMOVED***
        var current, next;
        var _a;
        return __generator(this, function (_b) ***REMOVED***
    ...
    ***REMOVED***;
    ...
    return ChatClient;
***REMOVED***(IrcClient));
export ***REMOVED*** ChatClient ***REMOVED***;
