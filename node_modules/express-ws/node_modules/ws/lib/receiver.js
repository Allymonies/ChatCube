...
class Receiver extends Writable ***REMOVED***
   ...
   *
   * @param ***REMOVED***String***REMOVED*** [binaryType=nodebuffer] The type for binary data
   * @param ***REMOVED***Object***REMOVED*** [extensions] An object containing the negotiated extensions
   * @param ***REMOVED***Boolean***REMOVED*** [isServer=false] Specifies whether to operate in client or
   *     server mode
   * @param ***REMOVED***Number***REMOVED*** [maxPayload=0] The maximum allowed message length
   */
  constructor(binaryType, extensions, isServer, maxPayload) ***REMOVED***
    super();
