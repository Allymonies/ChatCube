...
module.exports = function runSymbolTests(t) ***REMOVED***
	...
	*/
	...
	for (sym in obj) ***REMOVED*** t.fail('symbol property key was found in for..in of object'); ***REMOVED***
	...
	t.deepEqual(Object.getOwnPropertyDescriptor(obj, sym), ***REMOVED***
		configurable: true,
		enumerable: true,
		value: 42,
		writable: true
	***REMOVED***, 'property descriptor is correct');
***REMOVED***;
