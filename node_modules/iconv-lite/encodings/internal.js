...
module.exports = ***REMOVED***
    // Encodings
    utf8:   ***REMOVED*** type: "_internal", bomAware: true***REMOVED***,
    cesu8:  ***REMOVED*** type: "_internal", bomAware: true***REMOVED***,
    unicode11utf8: "utf8",

    ucs2:   ***REMOVED*** type: "_internal", bomAware: true***REMOVED***,
    utf16le: "ucs2",

    binary: ***REMOVED*** type: "_internal" ***REMOVED***,
    base64: ***REMOVED*** type: "_internal" ***REMOVED***,
    hex:    ***REMOVED*** type: "_internal" ***REMOVED***,
...
function InternalCodec(codecOptions, iconv) ***REMOVED***
    ...
    if (this.enc === "base64")
        ...
        if (Buffer.from('eda0bdedb2a9', 'hex').toString() !== '💩') ***REMOVED***
...
if (!StringDecoder.prototype.end) // Node v0.8 doesn't have this method.
    StringDecoder.prototype.end = function() ***REMOVED******REMOVED***;
