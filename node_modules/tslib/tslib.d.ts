...
export declare function __importDefault<T>(mod: T): T | ***REMOVED*** default: T ***REMOVED***;
/**
 * Reading from a private instance field
 */
export declare function __classPrivateFieldGet<T extends object, V>(
    receiver: T,
    state: ***REMOVED*** has(o: T): boolean, get(o: T): V | undefined ***REMOVED***,
    kind?: "f"
): V;
/**
...
export declare function __classPrivateFieldGet<T extends object, V>(
    receiver: T,
    state: ***REMOVED*** has(o: T): boolean ***REMOVED***,
    kind: "a",
    f: () => V
): V;
/**
 ...
 */
 export declare function __classPrivateFieldSet<T extends object, V>(
    receiver: T,
    state: ***REMOVED*** has(o: T): boolean, set(o: T, value: V): unknown ***REMOVED***,
    value: V,
    kind?: "f"
): V;
/**
